...
| 13 | 11/26,30   |          프로젝트 기획 및 개발 (대면수업 예정 - 상황에 따라 비대면 전환 가능)           | \-  |                                                                                               |      |
| 14 | 12/3,7   |             프로젝트 발표 리허설 (대면수업 예정 - 상황에 따라 비대면 전환 가능)             |   \-   |                                                                                               |      |
| 15 | 12/10,14   |              프로젝트 발표 (대면수업 예정 - 상황에 따라 비대면 전환 가능)              |   \-   |                                                                                               |      
